...
public class Config {
    ...
    public static final double DEFAULT_FIRE_RATE = 2.0;
    ...
    public static final Ship DEFAULT_SHIP = new Ship("starship", DEFAULT_TOP_SPEED, DEFAULT_ACCELERATION, DEFAULT_STARTING_SPEED, new Weapon(DEFAULT_WEAPON_DAMAGE, DEFAULT_FIRE_RATE),
            DEFAULT_LIVES, new Position(DEFAULT_STARTING_X, DEFAULT_STARTING_Y), DEFAULT_STARTING_ROTATION, DEFAULT_STARSHIP_SIZE, DEFAULT_COLLIDER_TYPE);
